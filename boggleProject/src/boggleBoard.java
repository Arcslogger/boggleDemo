/*==============================================================================
 ...
 R - number of rows of the board </type int>
 C - number of columns of the board </type int>
 wordlist - list of all valid english words </type HashSet<String>>
 board - holds values of all dice on current board </type String[][]>
 directions - list of all possible directions to search for a word </type ArrayList<coord>>
================================================================================
 */
...
public class boggleBoard {
    ...
    private static class coord {
        int r, c;
        /**
         * Constructor creates a coordinate pair with a specified row and column value.
    ...
    /**
     *  Selects a random latin character for each of the 36 dice on the grid. RNG is weighted to favour more commonly used letters.
     ...
     *
     *  List of Local Variables:
     *  r       loops through all row indices </type int>
     *  c       loops through all col indices </type int>
    ...
    private boolean searchDir (int r, int c, int dirR, int dirC, String val) {
        ...
        if(val.length() > 0 && board[r][c].equalsIgnoreCase(Character.toString(val.charAt(0))) && r + dirR < R && r + dirR >= 0 && c + dirC < C && c + dirC >= 0)
     ...
     *  and calls the recursive search to find whether a word can be created from that combination.
     *
     *  List of Local Variables:
     *  r   loops through every row of the board </type int>
     *  c   loops through every column of the board </type int>
     *  dir loops through every possible direction direction (UDLR + diagonals) </type coord>
     *
     *  @param val  string representing the word currently being searched for
